...
class TestPricingEngine:
    ...
    def test_clearance_electronics(self, engine, sample_customer_silver, sample_product_electronics, sample_order_small):
    ...
    def test_pricing_structure(self, engine, sample_customer_gold, sample_product_electronics, sample_order_large):
        ...
        required_fields = [
            'original_total', 'final_total', 'shipping_cost',
            'grand_total', 'applied_discounts', 'savings'
        ]
