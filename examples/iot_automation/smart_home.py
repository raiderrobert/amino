...
class SmartHomeSystem:
    ...
    def __init__(self):
        # Load the schema
        with open('examples/iot_automation/schema.amino', 'r') as f:
    ...
    def process_iot_data(self, sensor_data: Dict[str, Any], device_states: List[Dict[str, Any]],
                        home_context: Dict[str, Any], user_preferences: Dict[str, Any]) -> List[Dict[str, Any]]:
...
def main():
    ...
    print(f"   • home_context.occupancy_status = 'home'")
    print(f"   • sensor_readings.temperature = 65")
    print(f"   • home_context.security_mode = 'disarmed'")
