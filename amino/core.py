...
class Schema:
    ...
    def register_type(self, name: str, base_type: str, validator: Callable = None, **constraints):
...
def compile_rules(schema_ast: SchemaAST, rules: List[Dict[str, Any]]) -> CompiledRules:
