...
class RuleOptimizer:
    ...
    def _optimize_binary_op(self, node: BinaryOp) -> RuleNode:
        ...
        if isinstance(left, Literal) and isinstance(right, Literal):
            result = self._evaluate_literal_binary_op(node.operator, left, right)
    ...
    def _evaluate_literal_binary_op(self, operator: Operator, left: Literal, right: Literal) -> Literal:
        ...
        try:
            ...
            # If evaluation fails, return None to indicate no optimization
            pass
